...
# psm = PsmPy(sample_did, treatment='PC1_b_9', indx='idauniq', exclude = ['srh_9', 'srh_10',
#                                                                       'high_bp_9', 'high_bp_10', 'high_chol_9', 'high_chol_10', 'diabetes_9', 'diabetes_10',
#                                                                       'asthma_9', 'asthma_10', 'arthritis_9', 'arthritis_10', 'cancer_9', 'cancer_10',
#                                                                       'cesd_9', 'cesd_10', 'anxiety_9', 'anxiety_10', 'mood_9', 'mood_10',
...
#
# sample_did.loc[sample_did['idauniq'] == nmixx['idauniq'][0], 'PC1_b_9'].values[0]  # 1
# sample_did.loc[sample_did['idauniq'] == nmixx['matched_ID'][0], 'PC1_b_9'].values[0]  # 0
#
# ##### Calculate DiD
