...
\usepackage{float}
\usepackage{tabularray}  % for long tables and table notes
\UseTblrLibrary{booktabs}

% figure
\usepackage{caption}  % for figure notes
\usepackage{tikz}  % for drawing DAGs
...
\title{Navigating the digital age: How digital literacy influences health outcomes among older adults}
% \author{Your Name}
...
\include{text/ch3-hypothesis}
\include{text/ch4-strategy}
\include{text/ch5-result}
